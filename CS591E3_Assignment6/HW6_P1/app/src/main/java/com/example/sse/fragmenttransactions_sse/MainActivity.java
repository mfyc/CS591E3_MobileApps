/*
EXPLANATION: The first problem of the code was that, while the first fragment was being added to
the Fragment Transactions, the third fragment was not. Moreover, all three buttons had an inconsistent way
of adding and removing the fragments from the transaction (ie, the third fragment was attaching and
detaching, while the first fragment was hiding the others, while the second was replacing them). These
were all viable approaches, but they were not the same, making the fragments render incorrectly. This
was fixed by simply making fragments one and three replace the other two fragments when selected
and adding them to the backstack, much like fragment one was when it was added.
 */
